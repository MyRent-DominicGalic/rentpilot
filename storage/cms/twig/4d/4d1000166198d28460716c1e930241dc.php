...
/* E:\faks\_zavrsni\zavrsni tailorblueprint\themes/myrent/partials/builder/blogs/_posts.htm */
class __TwigTemplate_7e56ba9b5135756d0be7909cc47c6065 extends Template
{
...
";
    ...
    ";
            ...
            foreach ($context['_seq'] as $context["key"] => $context["item"]) {
                ...
                yield $this->env->getExtension(\Cms\Twig\Extension::class)->partialFunction("builder/blogs/_article"                , array_merge($context, ['__cms_partial_params' => $cmsPartialParams], $cmsPartialParams)                , true                );
                // line 62
                yield "    ";
            }
            $_parent = $context['_parent'];
...
";
            ...
            yield $this->env->getExtension(\Cms\Twig\Extension::class)->partialFunction("builder/blogs/_noresults"            , array_merge($context, ['__cms_partial_params' => $cmsPartialParams], $cmsPartialParams)            , true            );
        }
        // line 68
        yield "
";
...
";
    ...
    {
        return "E:\\faks\\_zavrsni\\zavrsni tailorblueprint\\themes/myrent/partials/builder/blogs/_posts.htm";
    }
...
{% endif %}", "E:\\faks\\_zavrsni\\zavrsni tailorblueprint\\themes/myrent/partials/builder/blogs/_posts.htm", "");
    }
}
