...
/* /home/myrent/htdocs/myrent.hr/themes/myrent/partials/builder/sections/articles.htm */
class __TwigTemplate_eb5491386ba1bcb26bdb978360d0be38 extends Template
{
    ...
    <div class=\"";
        ...
        if (Cms\Twig\GetAttrNode::customGetAttribute($this->env, $this->source, ($context["section"] ?? null), "show_category_nav", [], "any", false, false, false, 5)) {
            ...
            yield "          ";
            $cmsPartialParams = [];
            yield $this->env->getExtension(\Cms\Twig\Extension::class)->partialFunction("builder/articles/_sidebar"            , array_merge($context, ['__cms_partial_params' => $cmsPartialParams], $cmsPartialParams)            , true            );
            // line 7
            yield "        ";
        }
        // line 8
        ...
        // line 10
        $cmsPartialParams = [];
        yield $this->env->getExtension(\Cms\Twig\Extension::class)->partialFunction("builder/articles/_ajaxlist"        , array_merge($context, ['__cms_partial_params' => $cmsPartialParams], $cmsPartialParams)        , true        );
        // line 11
        yield "        </div>
    ...
    {
        return "/home/myrent/htdocs/myrent.hr/themes/myrent/partials/builder/sections/articles.htm";
    }
    ...
    <div class=\"{{ section.container_style ?? 'container' }}\">
        ...
        {% if section.show_category_nav %}
          {% partial 'builder/articles/_sidebar' %}
        {% endif %}

        <div id=\"posts-ajax\">
          {% partial 'builder/articles/_ajaxlist' %}
        </div>
...
</{{ section.html_tag ?? 'div' }}>", "/home/myrent/htdocs/myrent.hr/themes/myrent/partials/builder/sections/articles.htm", "");
    }
}
