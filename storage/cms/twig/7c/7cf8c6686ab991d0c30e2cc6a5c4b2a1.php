...
/* E:\faks\_zavrsni\zavrsni tailorblueprint\themes/myrent/partials/builder/blogs/_article.htm */
class __TwigTemplate_7c2f3062df3fc58b205206d8e6b468be extends Template
{
   ...
   <a href=\"";
        // line 2
        yield $this->extensions['Cms\Twig\Extension']->pageFilter("post", ["slug" => Cms\Twig\GetAttrNode::customGetAttribute($this->env, $this->source, ($context["item"] ?? null), "slug", [], "any", false, false, false, 2)]);
   ...
   <div class=\"p-4 flex-1 flex flex-col\">
       ...
       <div class=\"mt-6\">
        ...
        // line 13
        yield $this->extensions['Cms\Twig\Extension']->pageFilter("post", ["slug" => Cms\Twig\GetAttrNode::customGetAttribute($this->env, $this->source, ($context["item"] ?? null), "slug", [], "any", false, false, false, 13)]);
        yield "\">
               Pročitaj više
    ...
    {
        return "E:\\faks\\_zavrsni\\zavrsni tailorblueprint\\themes/myrent/partials/builder/blogs/_article.htm";
    }
   ...
   <a href=\"{{ 'post' | page({ slug: item.slug }) }}\" class=\"card_img h-44 w-full overflow-hidden relative\">
   ...
   <div class=\"p-4 flex-1 flex flex-col\">
       ...
       <div class=\"mt-6\">
           <a class=\"inline-flex items-center gap-2 font-bold bg-secondary bg-opacity-5 text-primary transition ease-out duration-300 hover:!bg-secondary hover:!text-white rounded-full px-5 py-2.5\" href=\"{{ 'post' | page({ slug: item.slug }) }}\">
               Pročitaj više
               <svg width=\"24\" height=\"24\" viewBox=\"0 0 24 24\" fill=\"none\" xmlns=\"http://www.w3.org/2000/svg\">
                   <path class=\"transition ease-out duration-300 fill-primary\" d=\"M14.7071 5.29289C14.3166 4.90237 13.6834 4.90237 13.2929 5.29289C12.9024 5.68342 12.9024 6.31658 13.2929 6.70711L17.5858 11H4C3.44772 11 3 11.4477 3 12C3 12.5523 3.44772 13 4 13H17.5858L13.2929 17.2929C12.9024 17.6834 12.9024 18.3166 13.2929 18.7071C13.6834 19.0976 14.3166 19.0976 14.7071 18.7071L20.7071 12.7071C21.0976 12.3166 21.0976 11.6834 20.7071 11.2929L14.7071 5.29289Z\" />
               </svg>
...
</article>", "E:\\faks\\_zavrsni\\zavrsni tailorblueprint\\themes/myrent/partials/builder/blogs/_article.htm", "");
    }
}
