...
/* E:\faks\_zavrsni\zavrsni tailorblueprint\themes/myrent/partials/builder/partials/card-slider-simple.htm */
  ...
  <div class=\"grid grid-cols-1 lg:grid-cols-5 gap-3\">
      ...
      ";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["item"]) {
            // line 12
            yield "      <a class=\"card_renter_sm flex flex-col shadow-lg rounded-xl overflow-hidden bg-white\" href=\"";
    ...
    {
        return "E:\\faks\\_zavrsni\\zavrsni tailorblueprint\\themes/myrent/partials/builder/partials/card-slider-simple.htm";
    }
...
<div class=\"{{ section.container_style }} px-4 relative z-10 mb-4\">
  ...
  <div class=\"grid grid-cols-1 lg:grid-cols-5 gap-3\">
      ...
      <a class=\"card_renter_sm flex flex-col shadow-lg rounded-xl overflow-hidden bg-white\" href=\"{{ item.button_page | link  }}\" {{ item.button_external ? 'target=\"_blank\" rel=\"noopener\"' }}>
          <div class=\"card_renter_img h-28 w-full overflow-hidden relative\">
...
</div>", "E:\\faks\\_zavrsni\\zavrsni tailorblueprint\\themes/myrent/partials/builder/partials/card-slider-simple.htm", "");
    }
}
